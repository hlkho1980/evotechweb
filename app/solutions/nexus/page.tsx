    ...
    <main className="min-h-screen bg-[#030712] text-white pt-28">
      <section className="max-w-7xl mx-auto px-6 py-20">
        <p className="text-cyan-400 font-semibold mb-4">
          On-Site Sales & Monitoring Management
        </p>
        ...
        NEXUS is a mobile sales and field operations platform that enables
        teams to manage orders, collections, customer visits, and GPS-based
        activities from anywhere. Improve productivity and gain real-time
